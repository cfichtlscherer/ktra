...
plt.axis(False)
plt.savefig(figures_path + 'sphere_cont.pgf', bbox_inches='tight')

#################### Plot the reconstruction from an npy file object #############################

data = np.load("sphere_reconstruction_results.npy")
...
plt.axis(False)
plt.savefig(figures_path + 'sphere_reconstruction.pgf', bbox_inches='tight')
