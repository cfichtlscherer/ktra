...
cd 20-0.2-0.02-1  && python3 douglas_rachford_multi.py &\
...
cd 20-0.2-0.03-1  && python3 douglas_rachford_multi.py &\
...
cd 20-0.2-0.03-2  && python3 douglas_rachford_multi.py &\
